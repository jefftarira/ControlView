...
! function (e, t) {
	...
	function n(e) {
		function t() {
			...
			"vertical" === t.resize ? e.style.resize = "none" : "both" === t.resize && (e.style.resize = "none"), s = "content-box" === t.boxSizing ? -(parseFloat(t.paddingTop) + parseFloat(t.paddingBottom)) : parseFloat(t.borderTopWidth) + parseFloat(t.borderBottomWidth), isNaN(s) && (s = 0), l()
		}
