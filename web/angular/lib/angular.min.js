  ...
  B.angular.bootstrap ? B.console && console.log("WARNING: Tried to load angular more than once.") : (ze(), Be(ga), ga.module("ngLocale", [], ["$provide", function (a) {
    ...
    a.value("$locale", {
      DATETIME_FORMATS: {
        ...
        ERAS: ["BC", "AD"],
        FIRSTDAYOFWEEK: 6,
        MONTH: "Enero Febrero Marzo April Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre".split(" "),
        SHORTDAY: "Dom Lun Mar Mie Jue Vie Sab".split(" "),
        SHORTMONTH: "Ene Feb Mar Abr May Jun Jul Ago Sep Oct Nov Dic".split(" "),
        STANDALONEMONTH: "Enero Febrero Marzo April Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre".split(" "),
        WEEKENDRANGE: [5, 6],
