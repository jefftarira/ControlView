...
public class IncidentesRangoFechas extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      String json = mBO.getConteoPorRangoFechas();
      ...
      Logger.getLogger(IncidentesRangoFechas.class.getName()).log(Level.SEVERE, null, ex);
