...
public class checkStepEmr extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (u != null) {
      ...
      try {
        ...
        String stepId = obj.getString("stepId");
        String clusterID = obj.getString("clusterID");
        
        MetricasBO mBO = new MetricasBO();
        String json = mBO.checkStepByClusterIDJobID(clusterID, stepId);
        ...
        Logger.getLogger(checkStepEmr.class.getName()).log(Level.SEVERE, null, ex);
