...
public class getListClusters extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (u != null) {
      ...
      try {
        ...
        String json = mBO.getClustersInfo();
        ...
        Logger.getLogger(getListClusters.class.getName()).log(Level.SEVERE, null, ex);
