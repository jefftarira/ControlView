...
public class TotalDataByYearCity extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      String json = mBO.getTotalDataPorAnioOrigen();
      ...
      Logger.getLogger(TotalDataByYearCity.class.getName()).log(Level.SEVERE, null, ex);
