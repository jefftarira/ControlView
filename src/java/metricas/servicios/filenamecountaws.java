...
public class filenamecountaws extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (u != null) {
      ...
      try {
        ...
        String json = mBO.getFileNameCountsAws();
        ...
        Logger.getLogger(filenamecountaws.class.getName()).log(Level.SEVERE, null, ex);
