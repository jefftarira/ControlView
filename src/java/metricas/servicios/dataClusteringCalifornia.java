...
public class dataClusteringCalifornia extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (u != null) {
      ...
      try {
        ...
        String json = mBO.getClusteringDataCalifornia(tableName);
        ...
        Logger.getLogger(dataClusteringCalifornia.class.getName()).log(Level.SEVERE, null, ex);
