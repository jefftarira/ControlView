...
import metricas.servicios.countRowsAws;
import metricasgcp.MetricasgcpBO;
import org.json.JSONException;
import org.json.JSONObject;
import usuarios.modelos.Usuario;

public class infotablesdataproc extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (u != null) {
      ...
      try {
        ...
        String json = mBO.getTotalRowTablesHive();
        ...
        Logger.getLogger(infotablesdataproc.class.getName()).log(Level.SEVERE, null, ex);
