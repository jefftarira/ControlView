...
public class launchstepdataproc extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (u != null) {
      ...
      try {
        ...
        String json = mBO.launchStepDataproc(archivo, iteraciones, clusters, clusterID, tableName);
        ...
        Logger.getLogger(launchstepdataproc.class.getName()).log(Level.SEVERE, null, ex);
