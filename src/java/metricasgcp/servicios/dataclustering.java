...
import metricas.servicios.dataClusteringCalifornia;
import metricasgcp.MetricasgcpBO;
import org.json.JSONException;
import org.json.JSONObject;
import usuarios.modelos.Usuario;

public class dataclustering extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (u != null) {
      ...
      try {
        ...
        String json = mBO.getDataClustering(tableName);
        ...
        Logger.getLogger(dataclustering.class.getName()).log(Level.SEVERE, null, ex);
