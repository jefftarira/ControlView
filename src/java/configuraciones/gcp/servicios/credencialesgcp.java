...
public class credencialesgcp extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    if (u != null) {
      ...
      try {
        CredencialesGcpBO creBo = new CredencialesGcpBO();
        out.println(creBo.getCredencialesGcp());
        out.flush();
        out.close();
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      Logger.getLogger(credencialesgcp.class.getName()).log(Level.SEVERE, null, ex);
    }
  }
